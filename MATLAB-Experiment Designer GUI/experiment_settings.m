...
data_type_config = uicontrol(subpnl3,'style', 'pushbutton',... 
                    'string', 'Data Config', ...
                    'units', 'normalized',... 
                    'position', [0.45 0.1 0.5 0.3],...
...
apply_button = uicontrol(fig,'style', 'pushbutton',... 
                    ...
                    'callback', {@ApplySettings1,mem_load_editbox,Items_load_editbox,Trails_load_editbox,...
                                ...
                                letter_range_editbox,mixed_ratio_editbox,mixed_randomise_editbox});
...
subpnl3.Visible = 'on';
 ...
 function data_config(source, event)
 
 fig = figure('Position', [403 246 530 210]);
 
 pnl1 = uipanel(fig,'Title','Data Configuration Options','FontSize',12, 'FontWeight','Bold',...
                'BackgroundColor','white',...
                'Position',[0.03 0.05 0.95 0.95]);
        
subpnl1 = uipanel(pnl1,'Position',[0.05, 0.1, 0.91, 0.85]);
 
number_range = uicontrol(subpnl1,'Style', 'Text',... 
                    'Units', 'Normalized',... 
...
number_range_editbox = uicontrol(subpnl1,'style','edit',...
                    'units', 'normalized',...
                    'HorizontalAlignment', 'center', ...
                    'String', '[0 9]', ...
...
letter_range = uicontrol(subpnl1,'Style', 'Text',... 
                    'Units', 'Normalized',... 
...
letter_range_editbox = uicontrol(subpnl1,'style','edit',...
                    'units', 'normalized',...
                    'HorizontalAlignment', 'center', ...
                    'String', '[A Z]', ...
                    'position', [0.05 0.1 0.3 0.2]);     
                
mixed_ratio_split = uicontrol(subpnl1,'Style', 'Text',... 
                    'Units', 'Normalized',... 
                    'Position', [0.4 0.65 0.4 0.3],...
                    'FontSize', 8, ...
                    'FontWeight', 'Bold',...
                    'String', 'Mixed Data Type Ratio Split');
                
mixed_ratio_editbox = uicontrol(subpnl1,'style','edit',...
                    'units', 'normalized',...
                    'HorizontalAlignment', 'center', ...
                    'String', '[15 15]', ...
                    'position', [0.45 0.55 0.3 0.2]);   
                
mixed_randomise = uicontrol(subpnl1,'Style', 'Text',... 
                    'Units', 'Normalized',... 
                    'Position', [0.4 0.15 0.4 0.3],...
                    'FontSize', 8, ...
                    'FontWeight', 'Bold',...
                    'String', 'Mixed Data Type - Randomise');
                
mixed_randomise_editbox = uicontrol(subpnl1,'style','edit',...
                    'units', 'normalized',...
                    'HorizontalAlignment', 'center', ...
                    'String', 'Yes', ...
                    'position', [0.45 0.1 0.3 0.2]);  
                
static_text = uicontrol(subpnl1,'Style', 'Text',... 
                    'Units', 'Normalized',... 
...
apply_button = uicontrol(fig,'style', 'pushbutton',... 
                    ...
                    'units', 'normalized',... 
                    'position', [0.77 0.86 0.2 0.06]); 
                    %5'callback', {@ApplySettings1,mem_load_editbox,Items_load_editbox,Trails_load_editbox,...
                                %subpnl3, percentage_editbox, split_ratio_editbox, subpnl7 });
...
Oricle_GUI_Handler('MemoryLoad',mem_load_editbox.String,'ItemsPerMem',Items_load_editbox.String,...
                    ...
                    'NumberRange',number_range_editbox.String, 'LetterRange',letter_range_editbox.String,'MixedRatioSplit',mixed_ratio_editbox.String, 'MixedRandom',mixed_randomise_editbox.String)
                            
%   disp( mem_load_editbox.String);
%   disp(Items_load_editbox.String);
%   disp(Trails_load_editbox.String);
%   disp(subpnl3.SelectedObject.String);
%   disp(percentage_editbox.String);
%   disp(split_ratio_editbox.String);
%   disp(subpnl7.SelectedObject.String);
 end 
